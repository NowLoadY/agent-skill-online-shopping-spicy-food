...
clawhub Skill: https://clawhub.com/NowLoadY/agentic-spicy-food
...
### Skill Integration
The Skill is designed for seamless deployment within the OpenClaw framework or any LLM-based agent system:
1. **clawhub Installation**: Agents can pull the skill directly using `clawhub install agentic-spicy-food`.
...
### Skill 集成
本 Skill 设计用于在 OpenClaw 框架或任何基于 LLM 的 Agent 系统中无缝部署：
1. **clawhub 安装**：Agent 可以直接使用 `clawhub install agentic-spicy-food` 拉取技能。
